        ...
        '<div class="modal-dialog modal-sm">' +
            '<div class="modal-content">' +
                ...
                '<div class="modal-body">' +
                    ...
                    '</a>&nbsp;&nbsp;' +
                    '<a data-toggle="tooltip" title="follow me on wechat" href="./img/wechat-qr.jpg" target="_blank">' +
                        '<i class="fa fa-lg fa-weixin"></i>' +
                    '</a>&nbsp;&nbsp;' +
                    '<a data-toggle="tooltip" title="follow me on qq" href="http://sighttp.qq.com/msgrd?v=3&uin=91\' +270680&site=&menu=yes" target="_blank">' +
